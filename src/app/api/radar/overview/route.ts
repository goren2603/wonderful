...
export async function GET(req:Request) {
  ...
  return NextResponse.json({company,themes:themes.map(({analysis,alert,...t})=>t),alerts,mentions,sentimentCounts,executiveMentionCount});
}
